      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 border-t-4 border-emerald-600">
        ...
        <form action={formAction} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isPending}
            className={`w-full text-white font-semibold py-3 rounded-lg mt-4 transition-colors ${isPending ? 'bg-emerald-400 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700'
              }`}
          >
        ...
        <div className="mt-6 text-center">
          <Link href="/cadastro/professor" className="text-sm text-emerald-600 hover:underline font-medium">
            Não está cadastrado? Realize seu cadastro aqui. 
          </Link>
        </div>
      </div>
    </main>
